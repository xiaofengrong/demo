...
CREATE TABLE `mall_cart` (
  ...
  `selected` int NOT NULL DEFAULT '1' COMMENT '是否已勾选：0-未勾选，1-已勾选',
...
CREATE TABLE `mall_category` (
  ...
  `type` int NOT NULL COMMENT '分类目录级别，例如1代表1级，2代表2级，3代表3级',
  `parent_id` int NOT NULL COMMENT '父id,也就是上一级目录id，如果是一级目录，那么父id为0',
...
insert  into `mall_category`(`id`,`name`,`type`,`parent_id`,`order_num`,`create_time`,`update_time`) values (3,'新鲜水果',1,0,1,'2019-12-18 01:17:00','2019-12-28 17:11:26'),(4,'橘子橙子',2,3,1,'2019-12-18 01:17:00','2019-12-28 16:25:10'),(5,'海鲜水产',1,0,2,'2019-12-18 01:17:00','2019-12-28 16:25:20'),(6,'精选肉类',1,0,3,'2019-12-18 01:17:00','2019-12-28 16:25:21'),(7,'螃蟹',2,5,1,'2019-12-18 01:17:00','2019-12-28 16:25:15'),(8,'鱼类',2,5,2,'2019-12-18 01:17:00','2019-12-28 16:25:16'),(9,'冷饮冻食',1,0,4,'2019-12-20 13:45:28','2019-12-28 16:25:22'),(10,'蔬菜蛋品',1,0,5,'2019-12-20 13:45:28','2019-12-28 16:25:23'),(11,'草莓',2,3,2,'2019-12-18 01:17:00','2019-12-28 15:44:42'),(12,'奇异果',2,3,3,'2019-12-18 01:17:00','2019-12-28 16:25:12'),(13,'海参',2,5,3,'2019-12-18 01:17:00','2019-12-28 16:25:17'),(14,'车厘子',2,3,4,'2019-12-18 01:17:00','2019-12-28 16:25:12'),(15,'火锅食材',2,27,5,'2019-12-18 01:17:00','2020-02-11 00:42:33'),(16,'牛羊肉',2,6,1,'2019-12-18 01:17:00','2019-12-28 16:25:18'),(17,'冰淇淋',2,9,1,'2019-12-18 01:17:00','2019-12-28 16:25:18'),(18,'蔬菜综合',2,10,1,'2019-12-18 01:17:00','2020-02-11 00:48:27'),(19,'果冻橙',3,4,1,'2019-12-18 01:17:00','2020-02-11 00:37:02'),(27,'美味菌菇',1,0,7,'2019-12-20 13:45:28','2020-02-10 23:20:36'),(28,'其他水果',2,3,4,'2019-12-18 01:17:00','2019-12-28 16:25:12');
...
CREATE TABLE `mall_order` (
  ...
  `order_status` int NOT NULL DEFAULT '10' COMMENT '订单状态：0-用户已取消，10-未支付（初始状态），20-已付款，30-已发货，40-交易完成',
...
CREATE TABLE `mall_product` (
  ...
  `image` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '产品图片路径地址',
...
CREATE TABLE `mall_user` (
  ...
  `password` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户密码，MD5  ',
...
insert  into `mall_user`(`id`,`username`,`password`,`personalized_signature`,`role`,`create_time`,`update_time`) values (2,'1','1','666',1,'2021-01-11 17:40:30','2021-01-11 17:40:30'),(3,'xiaomu','AWRuqaxc6iryhHuA4OnFag==','更新了我的签名',2,'2019-12-17 15:11:32','2020-02-10 09:52:12'),(4,'你好','AWRuqaxc6iryhHuA4OnFag==','',1,'2019-12-20 13:41:03','2020-02-10 09:52:15'),(5,'111','G72IZGCCcBXl1gXtRCUiUQ==','',1,'2019-12-27 19:34:56','2019-12-27 19:34:56'),(6,'444','uFfu1clAXB8rmASKrlBnkg==','cecc',1,'2019-12-27 19:38:03','2019-12-28 01:04:06'),(7,'你好2','JdVa0oOqQAr0ZMdtcTwHrQ==','',1,'2020-02-08 17:47:06','2020-02-08 17:47:06'),(8,'你好3','JdVa0oOqQAr0ZMdtcTwHrQ==','',1,'2020-02-08 17:49:15','2020-02-08 17:49:15'),(9,'你好4','12345678','',1,'2020-02-09 19:49:54','2020-02-09 19:49:54'),(10,'xiaomu2','AWRuqaxc6iryhHuA4OnFag==','祝你今天好心情',2,'2020-02-09 20:39:47','2020-02-11 00:56:02');
